...
<html lang="en">
  <head>
    ...
    <title> Reconhecimetno de Sinal Público</title>
...
<div class="col-lg-10 mx-auto p-3 py-md-5">
  ...
  <div class="alert alert-secondary" role="alert">
    <h1 class="h3"> Reconhecimento de sinal público</h1>
  
    <font size='4'>
    <h3>O que é</h3>
   
     <p> 
        É o reconhecimento da assinatura de um Tabelião ou Escrevente que atua em serventia de outra comarca.</p>
