...
<html lang="en">
  <head>
    ...
    <title> Termo de reconhecimento de firma por autenticidade</title>
...
<div class="col-lg-10 mx-auto p-3 py-md-5">
  ...
  <h2 class="escritura"> Dúvidas sobre o Reconhecimento por Autenticidade</h2>
    ...
    <div id="accordion">
      ...
      <div class="alert alert-dark" role="alert">       
        <div class="card-header">
          <a class="card-link" data-toggle="collapse" href="#collapseOne" style="color: #23425E">
        ...
        <div class="alert alert-dark" role="alert"> 
          <div class="card-body">
         A plataforma e-notariado, administrada pelo Colégio Notarial do Brasil, permite que você faça o reconhecimento por autenticidade pela internet, sem precisar ir até o cartório. Com ajuda de um certificado digital. O serviço é oferecido pelos tabeliães de notas do país para validar as assinaturas de documentos como escrituras, procurações, autorizações de viagens de menores de idade, testamentos, entre outros.
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <div id="accordion">
      ...
      <div class="alert alert-dark" role="alert">       
        <div class="card-header">
          <a class="card-link" data-toggle="collapse" href="#collapsetwo" style="color: #23425E">
        ...
        <div class="alert alert-dark" role="alert"> 
          ...
          Com seu certificado digital, basta fazer login no e-Notariado, escolher o serviço desejado e agendar sua videoconferência, que será conduzida pelo tabelião de notas, que indicará a abertura da gravação, a data e hora do início, e o nome completo dos participantes.
                              
          <hr>
          Emita já seu certificado digital notarizado, solicitando diretamente no sistema em <a href="http://https://www.e-notariado.org.br/customer/e-not-sign"> <font color=black>enotassina.com.br</font></a>    

            <br><br>
            <b>Para mais dúvidas acesse:</b> <a href="http://https://colegionotarialdobrasil.freshdesk.com/support/solutions/articles/43000659316-e-not-assina-manual-para-clientes"><font color=black>e-Not Assina - Manual para clientes</font></a>
