...
<div class="col-lg-10 mx-auto p-3 py-md-5">
  ...
  <font size='4'>
  <h2 class="escritura"> Dúvidas sobre o Certificado Digital</h2>
      ...
      <div class="alert alert-dark" role="alert">       
        <div class="card-header">
          <a class="card-link" data-toggle="collapse" href="#collapseOne" style="color: #23425E">
            Qual utilização do Certificado Digital?
          </a>
        </div>
        ...
        <div class="alert alert-dark" role="alert"> 
          ...
          Identidade digital de uma pessoa física ou jurídica, identificada presencialmente por um notário a quem se atribui fé pública; Com esse certificado, é possível assinar digitalmente todos os atos notariais disponíveis na plataforma do E-Notariado.
          </div>
            </div>
          </div>
        </div>
