...
<div class="col-lg-10 mx-auto p-3 py-md-5">
  ...
  <div class="alert alert-secondary" role="alert">
    <h1 class="h3">Pacto Antenupcial</h1>
    ...
    <font size='4'>
     ...
     <p> 
        ...
        O regime de bens começa a vigorar a partir da data do casamento e somente poderá ser alterado mediante autorização judicial..</p>
       
      <h3> O que é necessário para fazer o pacto antenupcial?</h3>
       
        <p>Antes do casamento, os noivos devem comparecer ao cartório de notas com os documentos pessoais (RG e CPF originais) e certidão de nascimento(se solteiros), para fazer o pacto antenupcial, caso desejem casar pelo regime da separação de bens, comunhão universal de bens, participação final nos aquestos ou regime de bens misto.</p>
