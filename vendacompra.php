...
<html lang="en">
  <head>
    ...
    <title> Escritura de Venda e Compra</title>
...
<div class="col-lg-10 mx-auto p-3 py-md-5">
  ...
  <h2 class="escritura"> Escritura de Venda e Compra</h2>
  <div style="text-align: justify;"> 
  <h3>O que é</h3>

  <p>A Escritura de Compra e Venda é o ato lavrado no cartório de notas por meio do qual uma das partes vende determinado bem (móvel ou imóvel) para outra. <br> <br> <b>Atenção: além de mais segura, muitas vezes a escritura pública custa menos do que os contratos particulares. Consulte sempre um tabelião antes de fechar um negócio imobiliário.</b></p>
  
  <h3>Como é feita?</h3>
  <font size='4'>
  <p> A escritura de compra e venda deve ser feita no Cartório de Notas, mediante agendamento prévio, para que seja coletada a documentação necessária à realização do negócio jurídico, bem como para que sejam feitos eventuais esclarecimentos às partes.
  ...
  <p> Vendedor Pessoa Física: <br>
      ...
      <p>- Número do CNPJ para obtenção da certidão via internet; <br>
          ...
          <h3> No caso de vendedor, poder-se solicitar ainda;</h3>

          <p>- Certidão da Justiça do Trabalho; <br>
              ...
              <p>- Certidao de nascimento: se solteiro <br>
                  - Certidão de Casamento: se casado, separado ou divorciado; <br>
                   - Pacto antenupcial registrado, se houver; <br>
                  - Certidão de óbito; <br>
                  - Informar endereço; <br>
                  - Informar profissão. <br> <br>
                   <b> Atenção:</b> o cônjuge deve ter CPF individual próprio.
                   ...
                   <h3>Documentos dos bens Imóveis:</h3>

                   <p>No caso de bem móvel, deve ser apresentado, quando possível, documento que comprove a propriedade do bem e o respectivo valor, por exemplo, documento único de transferência do veículo e respectiva cotação nos termos da tabela FIPE. <br>
